...
var activeFields, colNum = 1, num = 0,
    toRGB = (hex, reversed, integer) => {
        ...
        content: "You can __use__ **discord markdown here** ~~**`invite tokyo`**~~",
        embed: {
            title: "This is a cool embed title!",
            description: "You can use [hyperlink](https://dsc.gg/tokyo.uwu) or emojis :smile: 😎\n```js\nconst mid = require('mid')\n//You can use codeblocks!\n```",
            color: 4321431,
